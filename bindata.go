...
func dataNode_handlerTemplate() (*asset, error) {
	...
	info := bindataFileInfo{name: "data/node_handler.template", size: 3815, mode: os.FileMode(420), modTime: time.Unix(1501685462, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
